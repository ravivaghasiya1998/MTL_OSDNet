...
**Data preprocessing:** In `#ffffff preparation/prepare_lost_and_found.py` script can be used to generate binary mask of LostAndFound dataset serving as OoD proxy data.
